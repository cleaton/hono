...
import { RegExpRouterUpdated } from './router'

describe('Basic Usage', () => {
  const router = new RegExpRouterUpdated<string>()
...
describe('Complex', () => {
  let router: RegExpRouterUpdated<string>
  beforeEach(() => {
    router = new RegExpRouterUpdated<string>()
  })
...
describe('long prefix, then star', () => {
  ...
  describe('Including slashes', () => {
    ...
    // XXX This route can not be added with `:label` to RegExpRouterUpdated. This is ambiguous.
